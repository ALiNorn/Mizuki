...
export const siteConfig: SiteConfig = {
	title: "ALiN澪",
	subtitle: "澪の屋",
	siteURL: "https://alinweb.netlify.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "1240111", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: true, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "442229948", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/alinorn",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/442229948",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "ALiNorn/Comment",
		repoId: "R_kgDOSLPVgg",
		category: "Announcements",
		categoryId: "DIC_kwDOSLPVgs4C7lWT",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://meting.mikus.ink/api?server=netease&type=playlist&id=17923017604", // Meting API 地址
	id: "17923017604", // 歌单ID
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	models: ["/pio/models/snow_miku/model.json"], // 默认模型路径
	position: "left", // 模型位置
	width: 448, // 默认宽度
	height: 400, // 默认高度
